...
# make sure you all files working directory
...
#First we will datamine this massive dataset, first I need to obtain connections
...
#COMPLETE I have extracte two matrixes that holds the mean and std respectiely
